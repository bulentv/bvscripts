...
setlocal expandtab
if &filetype != 'debsources'
setlocal filetype=debsources
endif
...
if &syntax != 'debsources'
setlocal syntax=debsources
endif
setlocal tabstop=2
setlocal tagcase=
setlocal tags=
...
silent! normal! zE
let s:l = 52 - ((1 * winheight(0) + 10) / 21)
