...
silent only
cd /tmp/redis-5.0.3/utils
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/projects/incoder/config/local.json5
argglobal
silent! argdel *
$argadd ~/projects/incoder/config/local.json5
edit ~/projects/incoder/config/local.json5
